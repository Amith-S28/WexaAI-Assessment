...
| **JanusGraph** | TinkerPop Gremlin Framework (HTTP Server) | 88.74 ms | 853.8 | 1,266.3 | 51.20s |
...
| **KùzuDB** | 7.05 ms | 51.74 ms | **0.00 ms** | **0.00 ms** | **0.00 ms** |
| **JanusGraph** | 50.78 ms | 55.33 ms | **0.00 ms** | **0.00 ms** | **0.00 ms** |
| **ArcadeDB** | 4.92 ms | 51.90 ms | **0.00 ms** | **0.00 ms** | **0.00 ms** |